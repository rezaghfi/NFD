/*
 * soltani-strategy.hpp
 *
 *  Created on: Jun 26, 2019
 *      Author: reza
 */

#ifndef NDNSIM_NFD_DAEMON_FW_soltani_STRATEGY_HPP_
#define NDNSIM_NFD_DAEMON_FW_soltani_STRATEGY_HPP_
...
namespace nfd
{
	namespace fw
	{
		...
		/**
		 * this is Structure of parameter to set for soltani input
		 */
		struct FaceStats
		{
			Face *face;
		...
		class SoltaniStrategy : public Strategy
		{
		public:
			explicit SoltaniStrategy(Forwarder &forwarder, const Name &name = getStrategyName());
...
#endif /* NDNSIM_NFD_DAEMON_FW_soltani_STRATEGY_HPP_ */
